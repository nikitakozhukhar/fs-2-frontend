  ...
  return (
    <div className="flex flex-col w-[960px] border-2 border-b-4 border-gray-400">
              ...
              <div className="flex justify-around h-[50px] p-2 border-2 border-gray-400 rounded-lg ">
               ...
               <label className="flex items-center gap-2 cursor-pointer">
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <div className="flex items-center justify-center  peer-checked:bg-orange-500">
                    <span className="text-3xl text-black-700 font-bold">Ж</span>
                  </div>
                </label>
                </div>
              </div>
      ...
      <div className="flex justify-end px-4 py-8">
        <button className="px-10 py-2 border-[1px] border-[#292929] rounded-lg text-2xl font-bold">Следующий пассажир</button>
      </div>
    </div>
  );
};
