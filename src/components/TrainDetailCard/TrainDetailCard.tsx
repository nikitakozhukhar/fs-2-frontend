...
const TrainDetailCard = () => {
  return (
    <div className="train-detail-card">
      <div className="train-detail-col1">
        ...
        <div className="train-direction">
          ...
          <div className="train-middle-station">
            Москва <span className="arrow"></span>
          </div>
          <div className="train-destination-station ">Санкт-Петербург</div>
        </div>
      </div>

      <div className="train-detail-col2">
        <div className="direct-time-info">
          <div className="direct-from">
            <div className="direct-from-time">00:10</div>
            <div className="direct-from-city">Москва</div>
            <div className="direct-from-station">Курский вокзал</div>
          </div>

          <div className="direct-time-arrow">
            <div className="direct-time">9:42</div>
            <div className="direct-arrow-right">
              <svg
                width="30"
                height="20"
                viewBox="0 0 30 20"
          ...
          <div className="direct-to">
            <div className="direct-to-time">9:52</div>
            <div className="direct-to-city">Санкт-Петербург</div>
            <div className="direct-to-station">Ладожский вокзал</div>
          </div>
        </div>
        ...
        <div className="reverse-time-info">
          ...
          <div className="reverse-time-arrow">
            <div className="reverse-time">9:42</div>
            <div className="reverse-arrow-left">
              <svg
                width="30"
                height="20"
                viewBox="0 0 30 20"
      ...
      <div className="train-detail-col3">
        <div className="carriages-information">
          <div className="carriage-type">Сидячий</div>
          <div className="carriage-place-count">88</div>
          <div className="carriage-cost">
            <span className="text">от</span>
            <span className="carriage-price">2500</span>
            <span className="currency"></span>
          </div>
        </div>
        <div className="carriages-options">
          <div className="carriages-option">
            <svg
              width="24"
              height="19"
              viewBox="0 0 24 19"
